-- Migration: 000027_message_call_ringing
-- Добавляем статус 'ringing' — звонок инициирован, собеседник ещё не ответил
...
ALTER TABLE messages
    ...
    CHECK (call_status IS NULL OR call_status IN ('ringing', 'missed', 'ongoing', 'ended'));
