-- Migration: 000028_message_call_cancelled
-- 'cancelled' — инициатор отменил звонок не дождавшись ответа
...
ALTER TABLE messages
    ...
    CHECK (call_status IS NULL OR call_status IN ('ringing', 'missed', 'cancelled', 'ongoing', 'ended'));
