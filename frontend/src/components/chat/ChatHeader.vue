...
<template>
  <header class="h-14 px-4 flex items-center gap-3 border-b border-dark-800 bg-dark-900/50 backdrop-blur-sm">
    ...
    <div class="flex items-center gap-2 min-w-0">
      ...
      <h1 class="font-semibold text-white shrink-0">{{ channel.name }}</h1>
      <svg
    ...
    <InviteMemberModal :open="showInviteModal" @close="showInviteModal = false" />
    <ChannelSettingsModal :open="showSettings" :channel-id="channel.id" @close="showSettings = false" />
  </header>
</template>
