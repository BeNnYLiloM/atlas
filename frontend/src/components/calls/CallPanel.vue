...
<template>
  ...
  <div v-if="callsStore.isInCall" class="border-t border-dark-800 bg-dark-950 p-2">
      <!-- Статус подключения -->
      <div class="flex items-center gap-2 px-2 py-1 mb-1">
        ...
        <div class="flex-1 min-w-0">
          <p class="text-xs font-medium text-green-400 truncate">{{ currentChannelName() }}</p>
          <p class="text-xs text-dark-500">Голос подключён</p>
        </div>
      </div>
      ...
      <div class="flex items-center gap-1 px-1">
        ...
        >
          <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path v-if="!callsStore.isMuted" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-4-8a3 3 0 01-3-3V5a3 3 0 116 0v6a3 3 0 01-3 3z" />
